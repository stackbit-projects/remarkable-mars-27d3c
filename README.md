...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/6just8en/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id 6just8en --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://remarkable-mars-27d3c.sanity.studio/.
...
Generated at `2021-11-15T15:35:32.864Z` by Stackbit version `0.3.55`.